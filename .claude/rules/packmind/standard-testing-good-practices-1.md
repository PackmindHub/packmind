...
paths:
  ...
  - "**/*.test.tsx"
alwaysApply: false
description: 'Testing good practices'
---

## Standard: Testing good practices

Standardize unit test structure and naming in TypeScript/TSX test files using verb-first descriptions, Arrange-Act-Assert flow without comments, nested describe('when...') context blocks, and single-e... :
...
Full standard is available here for further request: [Testing good practices](../../../.packmind/standards/testing-good-practices-1.md)