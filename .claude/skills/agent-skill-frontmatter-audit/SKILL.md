...
description: Audit per-agent SKILL.md frontmatter support in Packmind against
  the current Agent Skills baseline specification and the latest official docs
  for each AI coding agent.
---
