...
- [Release CLI](commands/release-cli.md) : Automate creating a clean, tagged CLI release by validating git status, optionally promoting unreleased default skills, updating version and changelog with ISO dates in two commits, and pushing tags/commits to ensure consistent, traceable releases when publishing a new CLI version.
