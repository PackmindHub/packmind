...
- [Release app](commands/release-app.md) : Create a Packmind release by verifying a clean git state, bumping versions and updating the changelog, tagging and pushing the release, then reopening an Unreleased section to ensure consistent, traceable release workflows when publishing a new version.
