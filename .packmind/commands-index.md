...
- [Release CLI](commands/release-cli.md) : Automate creating a clean CLI release by updating versioning, changelog entries, tags, and comparison links so that releases are consistent, traceable, and ready for the next development cycle whenever you publish a new CLI version.
