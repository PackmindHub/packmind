...
- [Packmind Proprietary](./standards/packmind-proprietary.md) : Forbid importing from '@packmind/editions' in TypeScript files to prevent using OSS-only modules in proprietary codebases.
