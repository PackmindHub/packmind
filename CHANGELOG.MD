...
- **BREAKING**: CLI command renamed from `upload-skill` to `skills add` for better command organization (#71)
  - Migration: Replace `packmind-cli upload-skill <path>` with `packmind-cli skills add <path>`
