...
import { OrganizationChangeProposalsModule } from './organizations/change-proposals/change-proposals.module';
    ...
    RouterModule.register([
      ...
      },
      {
        ...
        children: [
          ...
          {
            path: 'changeProposals',
            module: OrganizationChangeProposalsModule,
          },
          {
            path: 'spaces',
