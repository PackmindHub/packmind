 ...
 */
const HEXA_REGISTRY_TOKEN = 'HEXA_REGISTRY';
const HEXA_REGISTRY_OPTIONS_TOKEN = 'HEXA_REGISTRY_OPTIONS';
...
const SKILLS_ADAPTER_TOKEN = 'SKILLS_ADAPTER';
const STANDARDS_ADAPTER_TOKEN = 'STANDARDS_ADAPTER';
export const GIT_ADAPTER_TOKEN = 'GIT_ADAPTER';
export const SPACES_ADAPTER_TOKEN = 'SPACES_ADAPTER';
const LINTER_ADAPTER_TOKEN = 'LINTER_ADAPTER';
const SPACES_MANAGEMENT_ADAPTER_TOKEN = 'SPACES_MANAGEMENT_ADAPTER';
...
export class HexaRegistryModule {
  ...
  private static createProviders(
    ...
    // PlaybookChangeManagement adapter
    providers.push({
      provide: PLAYBOOK_CHANGE_MANAGEMENT_ADAPTER_TOKEN,
      useFactory: (
        registry: HexaRegistry,
      ): IPlaybookChangeManagementPort | null => {
        try {
          const playbookChangeManagementHexa = registry.get(
