...
- Silently remove obsolete default skills on `install`, `init`, and `skills init`.
...
[Unreleased]: https://github.com/PackmindHub/packmind/compare/release-cli/0.28.1...HEAD
