...
<Info>
  If you need to invite users or manage roles, contact your organization
  administrator.
</Info>

<Tip>
  To learn how to create or switch between organizations, see [Managing
  Organizations](/administration/manage-organizations).
</Tip>
...
- **With SMTP configured**: Invitation emails are sent automatically to the invited users. See [SMTP Configuration](/getting-started/gs-install-self-hosted#smtp-configuration) for setup instructions.
