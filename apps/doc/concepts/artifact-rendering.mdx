...
Some AI assistants (**AGENTS.md**, **GitLab Duo**, **Junie**) use a single shared file rather than a dedicated folder for standards. Because you may want to add your own instructions to these files, Packmind uses HTML comment markers to delineate its managed section:
...
<Note>
  Skills are currently available for GitHub Copilot, Claude Code, Cursor, and
  GitLab Duo. Other AI assistants do not support skill rendering.
</Note>
