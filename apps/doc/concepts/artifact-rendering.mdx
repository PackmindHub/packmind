...
Some AI assistants (**AGENTS.md**, **GitLab Duo**, **Junie**, **OpenCode**) use a single shared file rather than a dedicated folder for standards. Because you may want to add your own instructions to these files, Packmind uses HTML comment markers to delineate its managed section:
...
<Note>
  ...
  Duo, and OpenCode. Other AI assistants do not support skill rendering.
</Note>
...
1. Skills are only rendered for GitHub Copilot, Claude Code, Cursor, and GitLab Duo
