...
The easiest way to create a skill is using the `/packmind-create-skill` command in your AI coding assistant.
...
<Note>
  Skills are currently available for Claude Code, Cursor, GitHub Copilot, and
