...
:::warning
The MCP server **must** be configured to create Commands.
...
:::tip
The workflow ensures commands are well-structured and reusable by enforcing clear steps, validation checkpoints, and usage scenarios. This makes them effective for AI agents and team members alike.
:::
