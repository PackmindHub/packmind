...
For information about Packmind Cloud security and privacy, see [Security & Privacy](security-privacy.md).
...
- [Install Packmind on your server](gs-install-self-hosted.md) - Setup instructions for self-hosted deployments
- [Security & Privacy](security-privacy.md) - Security information for Packmind Cloud
