...
Once you're authenticated, the first command to run inside your project is `packmind-cli init`. This sets up Packmind for the repository and must be run before any onboarding or artifact generation.
