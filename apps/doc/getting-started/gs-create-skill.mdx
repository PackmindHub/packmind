...
The easiest way to create a skill is using the built-in `/create-skill` command with your AI coding assistant.
...
This installs Packmind's default skills, including the `create-skill` skill that guides you through creating new skills.
...
Once default skills are installed, invoke the `/create-skill` command in your AI coding assistant:
