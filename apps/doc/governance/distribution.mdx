...
<Note>
  **Default skills included** — All distributions automatically include
  Packmind's default skills (such as `create-skill` for creating new skills with
  AI assistance). These are added alongside your package contents regardless of
  which distribution method you use.
</Note>
