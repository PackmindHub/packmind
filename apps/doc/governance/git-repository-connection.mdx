...
<Tip>
  **Self-hosting Packmind?** A GitHub App is a more durable alternative to a
  Personal Access Token — it is not tied to a single user and survives staff
  turnover. See [GitHub App Setup (Self-Hosted)](/governance/github-app-setup)
  for the full registration guide.
</Tip>
