...
- [Publish to a marketplace](/governance/marketplaces) — link a marketplace, publish packages as plugins, and monitor adoption
...
- [Packmind CLI](/tools/cli) — reference for the `packmind-cli plugins delete` command, which removes a rendered plugin from a local workspace clone
