...
<Warning title="The MCP server **must** be configured to create Commands.">
  See the setup guide: [Get started with the MCP
  server](/getting-started/gs-mcp-server-setup).
</Warning>
...
<Tip title="The workflow ensures commands are well-structured and reusable by enforcing clear steps, validation checkpoints, and usage scenarios. This makes them effective for AI agents and team members alike.">
