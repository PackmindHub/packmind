...
<Info title="Read more about the anatomy of a Packmind standard in the [dedicated section](/concepts/standards-management).">

</Info>

## Create a standard from your codebase

<Warning title="You need to connect your MCP server to your IDE. See the setup guide: [Get started with the MCP server](/getting-started/gs-mcp-server-setup).">
...
<Tip title="The workflow ensures consistent, high-quality standards by guiding the AI through best practices. You can provide feedback at any step, and the agent will refine the standard before submitting it.">
