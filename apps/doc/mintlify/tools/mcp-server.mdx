---
title: 'MCP Server: Connect AI Agents to Packmind'
---
...
Once you've configured your MCP server (see [MCP Server Setup](/getting-started/gs-mcp-server-setup)), you can use these tools through your AI agent.
...
<Warning title="Do not call this tool directly. AI agents must first complete the standard creation workflow using `create_standard`.">

</Warning>

<Tip title="When creating new standard using `save_standard`, you can include the optional `packageSlugs` parameter to automatically add it to packages during creation.">
...
<Warning title="Do not call this tool directly. AI agents must first complete the add rule workflow using `create_standard_rule`.">
...
<Warning title="Do not call this tool directly. AI agents must first complete the command creation workflow using `create_command`.">

</Warning>

<Tip title="When creating new command using `save_command`, you can include the optional `packageSlugs` parameter to automatically add them to packages during creation.">
...
<Note title="You typically don't call this tool directly. The AI agent will automatically use it based on the instructions from `install_package` when `packmind-cli` is not available.">
