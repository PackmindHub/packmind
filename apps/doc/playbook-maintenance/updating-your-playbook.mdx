...
```bash
packmind playbook add <path/to/element>
...
| **How**                 | Web interface (standards & commands) or `packmind playbook add` | `packmind-update-playbook` skill or `packmind playbook` commands |
