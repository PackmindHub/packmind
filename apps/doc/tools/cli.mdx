...
<Note>
  **Default skills included** — When you install packages, Packmind's default
  skills (including the `create-skill` skill) are automatically installed
  alongside your package contents.
</Note>
...
- **create-skill** — A skill that guides you through creating new skills with AI assistance
- **packmind-standard-create** — A skill for creating coding standards

After running this command, you can use the `/create-skill` command in your AI coding assistant to create new skills interactively.
