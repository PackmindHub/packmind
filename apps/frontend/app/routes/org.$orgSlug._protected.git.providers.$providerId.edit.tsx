...
import { EditGitProviderPage } from '../../src/domain/git/components';
import { AutobreadCrumb } from '../../src/shared/components/navigation/AutobreadCrumb';
import { GitProviderId } from '@packmind/git';

export default function EditGitProviderRoute() {
  ...
  useEffect(() => {
    ...
    if (
      ...
      navigate(`/org/${organization.slug}/git/providers/${providerId}/edit`, {
        replace: true,
      });
    }
  ...
  if (isLoading) {
    return (
      <PMPage
        title="Loading..."
        subtitle="Preparing git provider edit"
  ...
  return (
    <PMPage
      title="Edit Git Provider"
      subtitle="Update your git provider settings"
      breadcrumbComponent={<AutobreadCrumb />}
    >
