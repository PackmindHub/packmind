...
import { GitRepositoriesPage } from '../../src/domain/git/components';
import { AutobreadCrumb } from '../../src/shared/components/navigation/AutobreadCrumb';
import { GitProviderId } from '@packmind/git';

export default function GitRepositoriesRoute() {
  ...
  useEffect(() => {
    ...
    if (
      ...
      navigate(
        `/org/${organization.slug}/git/providers/${providerId}/repositories`,
        { replace: true },
      );
    }
  ...
  if (isLoading) {
    return (
      <PMPage
        title="Loading..."
        subtitle="Preparing repositories"
  ...
  return (
    <PMPage
      title="Repositories"
      subtitle="Manage repositories for your git provider"
      breadcrumbComponent={<AutobreadCrumb />}
    >
