...
import { CommandVersionHistoryHeader } from './CommandVersionHistoryHeader';
...
export const CommandDetails = ({ id, orgSlug }: CommandDetailsProps) => {
      ...
      {recipe && organization?.id && spaceId && (
        <>
          ...
          <ProposeDescriptionChangeModal
            commandDescription={recipe.content}
            recipeId={recipe.id}
            organizationId={organization.id}
            spaceId={spaceId}
