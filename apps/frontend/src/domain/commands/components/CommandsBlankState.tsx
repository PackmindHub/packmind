...
import { CommandsExampleDialog } from './CommandsExampleDialog';

interface CommandsBlankStateProps {
  orgSlug: string;
  spaceSlug: string;
}

export const CommandsBlankState = ({
  orgSlug,
  spaceSlug,
}: CommandsBlankStateProps) => {
