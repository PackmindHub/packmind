...
export const ProposeDescriptionChangeModal = ({
  ...
  const proposedDescriptionRef = useRef(commandDescription);
  ...
  const handleMarkdownChange = (value: string) => {
    ...
    setHasChanged(value.trim() !== commandDescription.trim());
  };
  ...
  const handleOpenChange = (details: { open: boolean }) => {
    if (!details.open) {
      proposedDescriptionRef.current = commandDescription;
      setHasChanged(false);
      setError(null);
    }
            ...
            <PMDrawer.Body padding={5}>
              <PMVStack gap={4} align="stretch">
                ...
                >
                  <MarkdownEditorProvider>
                    <MarkdownEditor
                      defaultValue={commandDescription}
