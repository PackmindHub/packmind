...
import { PMButton, PMList, PMText, PMTooltip, PMVStack } from '@packmind/ui';

interface OutdatedSectionProps {
  onGenerateProgramClick: () => void;
  isGenerating?: boolean;
}

export const OutdatedSection: React.FC<OutdatedSectionProps> = ({
