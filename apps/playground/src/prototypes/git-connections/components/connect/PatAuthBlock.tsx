...
const TOKEN_PLACEHOLDER: Record<Vendor, string> = {
  github: 'ghp_xxxxxxxxxxxxxxxxxxxx',
  gitlab: 'glpat-xxxxxxxxxxxxxxxxxxxx',
};

const PERMISSIONS_COPY: Record<Vendor, string> = {
  github:
...
export function PatAuthBlock({
  vendor,
  value,
  error,
  disabled,
  onChange,
}: Readonly<PatAuthBlockProps>) {
  return (
...
function PermissionsPopover({ vendor }: Readonly<{ vendor: Vendor }>) {
  return (
