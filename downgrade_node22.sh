...
echo "⬇️  Downgrade Node 22 — Nettoyage du workspace"
echo "================================================"
...
# 10. Installer et activer Node 22.17.0 via nvm
echo ""
echo "📦 Installation de Node 22.17.0..."
...
echo ""
echo "✅ Downgrade terminé ! Node version : $(node -v)"
