...
paths:
  - "**/*.ts"
alwaysApply: false
description: 'Domain events enable communication between hexas without creating direct dependencies. Apply these rules when creating events, emitting them, or implementing listeners to react to events from other domains.'
---
