...
} from '../useCases/getRecipeUsageAnalytics/getRecipeUsageAnalytics.usecase';
import { GetUsageByOrganizationUsecase } from '../useCases/getUsageByOrganization/getUsageByOrganization.usecase';
import { GetUsageByRepositoryUsecase } from '../useCases/getUsageByRepository/getUsageByRepository.usecase';
import { GetUsageByTargetUsecase } from '../useCases/getUsageByTarget/getUsageByTarget.usecase';
import { TrackRecipeUsageUsecase } from '../useCases/trackRecipeUsage/trackRecipeUsage.usecase';
...
export class AnalyticsAdapter implements IAnalyticsPort {
  ...
  constructor(
    ...
    this.logger.info('AnalyticsAdapter initialized successfully');
  }
