...
const CREATE_PACKAGE_README = `# Package Creator
      ...
      createOrUpdate: [
        {
          ...
          content: getCreatePackageSkillMd(),
        },
        {
          path: `${basePath}/README.md`,
          content: CREATE_PACKAGE_README,
        },
        {
          path: `${basePath}/LICENSE.txt`,
          content: CREATE_PACKAGE_LICENSE,
        },
      ],
      delete: [],
    };
