export const COMPLETION_SUMMARY_0350 = `## Completion Summary (CLI 0.35.0)
...
Next steps:
  ...
  - Run \`packmind install @$SPACE_SLUG/[package-slug]\` in other repos to distribute them
============================================================
\`\`\`
...
You can fix and re-run, or create manually with:
  ...
  packmind playbook add --space <space-slug> .packmind/standards/_drafts/<slug>.md
  cp .packmind/commands/_drafts/<slug>.draft.md .packmind/commands/_drafts/<slug>.md
  packmind playbook add --space <space-slug> .packmind/commands/_drafts/<slug>.md
  packmind playbook submit --no-review
  packmind packages add --to @<space-slug>/<package-slug> --standard <slug>
  packmind packages add --to @<space-slug>/<package-slug> --command <slug>
============================================================
\`\`\`
