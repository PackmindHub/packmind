import { GenericCommandSectionWriter } from './GenericCommandSectionWriter';
...
Some content after`;
      ...
      beforeEach(() => {
        result = GenericCommandSectionWriter.replace(opts);
      });
...
<!-- end: my-marker -->`;
  ...
  describe('generateRecipesSection', () => {
    describe('when using recipesSection', () => {
      ...
      beforeEach(() => {
        result = GenericCommandSectionWriter.generateCommandsSection(opts);
      });
