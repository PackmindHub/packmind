...
export class CommandSummaryService {
  constructor(
  ...
  public async createCommandSummary(
    ...
    try {
      ...
      const fullPrompt = `${createCommandSummaryPrompt}\n\n${commandVersionData.content}`;

      this.logger.debug('Built AI prompt for recipe summary', {
        promptLength: fullPrompt.length,
        contentLength: commandVersionData.content.length,
      });
