...
export class ListDistributionsByCommandUseCase implements IListDistributionsByCommand {
  constructor(
  ...
  public async execute(
    ...
    try {
      const distributions = await this.distributionRepository.listByCommandId(
        command.recipeId,
