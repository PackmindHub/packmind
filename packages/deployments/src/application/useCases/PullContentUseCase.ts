...
## How to contribute?
1. **Create an account**: Sign up to access the playbook management features and setup instructions. Ask you agent: \`Get the activation link for my Packmind account\`
