export const convert_rule_guidelines_heuristics_to_ast = `
## Context:
...
* Keep in mind that the original coding rule description and heuristics have been written by human and target actual source code. You need to keep the conversion to AST and JSON mode in mind.
...
This coding rule concerns source code written in $RULE_LANGUAGE$.

Here are the detection heuristics for the coding rule:
"""
$RULE_HEURISTICS$
"""
