    ...
    describe('when content has changed', () => {
      ...
      beforeEach(async () => {
        inputData = {
          ...
          rules: [{ content: 'Updated rule content' }],
    ...
    describe('when content has not changed', () => {
      ...
      beforeEach(async () => {
        inputData = {
          ...
          rules: [{ content: 'Same rule 1' }, { content: 'Same rule 2' }],
          organizationId: organizationId,
          userId: userId,
          scope: null,
        };
    ...
    describe('when name does not change but other content changes', () => {
      ...
      beforeEach(async () => {
        ...
        inputData = {
          ...
          rules: [{ content: 'Updated rule 1' }], // Different rules
          organizationId: organizationId,
          userId: userId,
          scope: null,
        };
    ...
    describe('content change detection', () => {
      ...
      it('detects rule count changes', async () => {
        ...
        const inputData: UpdateStandardRequest = {
          ...
          name: 'Original Name',
          description: 'Original description',
          rules: [{ content: 'Rule 1' }], // Fewer rules
          organizationId: organizationId,
          userId: userId,
          scope: null,
        };
      ...
      it('detects rule content changes', async () => {
        ...
        const inputData: UpdateStandardRequest = {
          ...
          name: 'Original Name',
          description: 'Original description',
          rules: [{ content: 'Modified rule content' }], // Changed content
          organizationId: organizationId,
          userId: userId,
          scope: null,
        };
